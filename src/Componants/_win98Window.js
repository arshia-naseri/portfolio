  ...
  return (
    <>
      <dialog
        data-popup-dialog
        id={id}
        className={`win98-window h-screen w-full flex-col overflow-hidden bg-[rgb(192,192,192)] outline-none backdrop:bg-black/50 sm:max-h-[80vh] sm:min-w-[max(30vw,fit-content)] sm:max-w-[60vw] ${isEasyToRead ? "font-sans" : "font-vcr"}`}
      >
